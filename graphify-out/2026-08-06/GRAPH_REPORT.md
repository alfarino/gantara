...
## Corpus Check
- 105 files · ~40,329 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 417 nodes · 753 edges · 44 communities (32 shown, 12 thin omitted)
...
### Community 0 - "useAuth"
Cohesion: 0.05
Nodes (74): EventBencana, EventBencanaPage(), EventDetail, fetcher(), PoskoInfo, STATUS_BENCANA_OPTIONS, TimelineItem, TIPE_BENCANA_OPTIONS (+66 more)
...
Cohesion: 0.26
Nodes (11): POST(), POST(), VALID_HUNIAN, VALID_ZONA, cleanExpired(), createSession(), deleteSession(), getSession() (+3 more)

### Community 7 - "resilientFetch.ts"
Cohesion: 0.24
Nodes (8): html5-qrcode, html5-qrcode, QrScannerPage(), OfflineQueueBanner(), useOfflineQueue(), OfflineTransaction, queueTransaction(), resilientFetch()
